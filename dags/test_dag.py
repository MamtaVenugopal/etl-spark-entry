...
# Define the DAG
with DAG('test_dag', default_args=default_args, schedule_interval=None) as dag:
    # Create EMR cluster
        ...
        steps=[
            {
                ...
                'HadoopJarStep': {
                    ...
                    'Args': ['spark-submit', '--deploy-mode', 'cluster', 's3://{{ var.value.S3_DATA_BUCKET }}/src/jobs/test.py'],
                },
            },
        ],
    )
