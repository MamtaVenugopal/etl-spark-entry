"""Auto-generated structural tests for US-1779670319535."""
from pathlib import Path

PROJECT_ROOT = Path(__file__).resolve().parents[1]
PIPELINE = PROJECT_ROOT / "src/jobs/product_category_order_count_month.py"
...
def test_target_referenced():
    text = PIPELINE.read_text(encoding="utf-8")
    assert "product_category_order_count_month" in text or "gold.product_category_order_count_month" in text
