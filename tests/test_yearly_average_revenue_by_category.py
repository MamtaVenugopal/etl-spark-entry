"""Auto-generated structural tests for US-1779835881488."""
from pathlib import Path

PROJECT_ROOT = Path(__file__).resolve().parents[1]
PIPELINE = PROJECT_ROOT / "src/jobs/yearly_average_revenue_by_category.py"
...
def test_target_referenced():
    text = PIPELINE.read_text(encoding="utf-8")
    assert (
        "yearly_average_revenue_by_category" in text
        or "gold.yearly_average_revenue_by_category" in text
