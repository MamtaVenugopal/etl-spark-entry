"""Auto-generated structural tests for US-1779821102879."""
from pathlib import Path

PROJECT_ROOT = Path(__file__).resolve().parents[1]
PIPELINE = PROJECT_ROOT / "src/jobs/monthly_average_revenue_by_product.py"
...
def test_target_referenced():
    text = PIPELINE.read_text(encoding="utf-8")
    assert (
        "monthly_average_revenue_by_product" in text
        or "gold.monthly_average_revenue_by_product" in text
