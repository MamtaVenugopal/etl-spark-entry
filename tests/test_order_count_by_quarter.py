"""Auto-generated structural tests for US-1779680769880."""
from pathlib import Path

PROJECT_ROOT = Path(__file__).resolve().parents[1]
PIPELINE = PROJECT_ROOT / "src/jobs/order_count_by_quarter.py"
...
def test_target_referenced():
    text = PIPELINE.read_text(encoding="utf-8")
    assert (
        "order_count_by_quarter" in text
        or "gold.order_count_by_quarter" in text
